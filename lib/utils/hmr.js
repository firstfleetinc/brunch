...
'use strict';
export const isEnabled = config => config.hot && !config.env.includes('production');
export const generate = (generateModuleFiles, nonModuleFiles, processor, deppack, definition, path, root) => {
